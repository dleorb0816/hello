...
//        rdoRabbit = (RadioButton) findViewById(R.id.RdoRabbit);
        ...
        rdoArr[0] = (RadioButton) findViewById(R.id.RdoDog);
        rdoArr[1] = (RadioButton) findViewById(R.id.RdoCat);
        rdoArr[2] = (RadioButton) findViewById(R.id.RdoRabbit);
...
//                    btnOK.setVisibility(android.view.View.VISIBLE);
        ...
        int [] nDrawable = {R.drawable.dog, R.drawable.cat, R.drawable.rabbit};
        ...
        for(int i=0; i<nDrawable.length; ++i)
        {
            ...
            rdoArr[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    imgPet.setImageResource(nDrawable[index]);
                }
            });
        }
...
//        btnInit = (Button) findViewById(R.id.btnFinish);
