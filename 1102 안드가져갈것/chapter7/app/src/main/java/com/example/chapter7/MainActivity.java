...
public class MainActivity extends AppCompatActivity {
    ...
    Button first,second,third,fourth,fifth,sixth,seventh,eighth,nineth,tenth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nineth = (Button) findViewById(R.id.ninthBtn);
        nineth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nineth_intent = new Intent(MainActivity.this,NinethActivity.class);
                startActivity(nineth_intent);
            }
        });

        tenth = (Button) findViewById(R.id.tenthBtn);
        tenth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent tenth_intent = new Intent(MainActivity.this,tenthActivity.class);
