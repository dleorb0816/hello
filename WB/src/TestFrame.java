...
//		double BMI_result= Weight/((height/100)*(height/100));
		...
		JTextArea result_textArea = new JTextArea(10,3);
		result_textArea.setColumns(3);
		result_textArea.setRows(10);
		...
		check_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String name = name_tf.getText();
				//result_textArea.setText(String.format("%.2f", BMI));
				result_textArea.setText("아름다운"+name+"의 신체질량지수는"+BMI);
			}
		});
