...
<body>
	...
	<table border="1">
		...
		<tr>
			<td colspan="4">
				<input type="button" value="글수정" onclick="location.href='updateForm.jsp?num=<%=num %>&pageNum=<%=pageNum %>'"><!-- pageNum이 있는 이유: updateFrom에서 글목록을 누르면 pageNum을 사용해서 그 페이지로 넘어가기 때문에 -->
